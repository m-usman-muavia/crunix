  ...
  return (
    <div className="sp-page">
      <header className="sp-header">
        <img src="/logo512.png" alt="Crunix" className="sp-logo" />
        <div className="sp-brand">
          <span className="sp-brand-mark">&#8801;</span>
          <span>CRUNIX</span>
        </div>
        <p className="sp-tagline">Sign in to continue</p>
      </header>
      ...
      <div className="sp-card">
        <form className="sp-form" onSubmit={handleSubmit}>
          ...
          <div className="sp-forgot-row">
            <Link to="/forgotpassword" className="sp-forgot-link">Forgot password?</Link>
          </div>
